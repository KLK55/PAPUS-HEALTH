...
<div class="navbar">
        <nav>
            <img src="./ASSES/logo.png" alt="logo">
	...
	<div class="container p-5 my-5 bg-dark text-white koko">            
            <div class="input-group mb-3">
             <div class="container">
              <div class="row">
                <div class="col">
                  <h5>Piso:1 <br>Sala:5 </h5>
                </div>
                <div class="col">
                  <h5>Nombre de Paciente: <br>EL VENDAS</h5>
                </div>
                <div class="col-md-6 offset-md-3 row form" >
                  <button class="btn btn-info " ><a class="SHH" href="./ASSES/Estado.pdf" download="VEDAS">Historial Medico</a></button>
                </div>
            ...
            <div class="input-group mb-3">
             <div class="container">
              <div class="row">
                ...
                <div class="col">
                  <h5>Nombre de Paciente: <br>EL LOKO JOUNS</h5>
                </div>
                <div class="col-md-6 offset-md-3 row form" >
                  <button class="btn btn-info"><a class="SHH" href="./ASSES/Estado_Loco_jouns.pdf" download="JOUNS">Historial Medico</a></button>
                </div>
                <div class="col col-lg-2 medio">
                <form style="border-radius=8px " action="./PHP/estado.php" method="POST" name="estado">
                <select class="form-select medio" aria-label="Default select example">
